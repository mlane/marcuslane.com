...
- **Svelte**: Svelte is used for building the user interface components of the game, providing a reactive and efficient framework for dynamic web applications.
...
5. Open your preferred web browser and navigate to `http://localhost:5000` to play the game.
